...
def main():
    parser = argparse.ArgumentParser(description="Rename FMASK files to standardized format")
    parser.add_argument("--root", default=r"D:\data\lsat", help="Root directory to scan")
