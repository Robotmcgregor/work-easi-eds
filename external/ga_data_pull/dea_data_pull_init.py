...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Pipeline: SR + FC + Fmask Masking by Date")
    parser.add_argument("--path", type=str, required=True, help="Landsat path (e.g. 091)")
    parser.add_argument("--row", type=str, required=True, help="Landsat row (e.g. 078)")
    parser.add_argument("--output_dir", type=str, default=r"D:\projects\working\lsat", help="Output directory")
    parser.add_argument("--cloud_threshold", type=float, default=10, help="Max cloud cover allowed")
