...
class AustralianTileGrid:
    ...
    def _get_australian_tile_definitions(self) -> List[Dict]:
        ...
        path_row_combinations = [
            # Western Australia
            (90, 77), (90, 78), (90, 79), (90, 80), (90, 81), (90, 82),
            (91, 76), (91, 77), (91, 78), (91, 79), (91, 80), (91, 81), (91, 82),
            (92, 76), (92, 77), (92, 78), (92, 79), (92, 80), (92, 81), (92, 82),
            
            # Central Australia
            (93, 74), (93, 75), (93, 76), (93, 77), (93, 78), (93, 79), (93, 80), (93, 81),
            (94, 73), (94, 74), (94, 75), (94, 76), (94, 77), (94, 78), (94, 79), (94, 80), (94, 81),
            (95, 72), (95, 73), (95, 74), (95, 75), (95, 76), (95, 77), (95, 78), (95, 79), (95, 80),
            (96, 72), (96, 73), (96, 74), (96, 75), (96, 76), (96, 77), (96, 78), (96, 79), (96, 80),
            (97, 71), (97, 72), (97, 73), (97, 74), (97, 75), (97, 76), (97, 77), (97, 78), (97, 79),
            (98, 70), (98, 71), (98, 72), (98, 73), (98, 74), (98, 75), (98, 76), (98, 77), (98, 78), (98, 79),
            (99, 70), (99, 71), (99, 72), (99, 73), (99, 74), (99, 75), (99, 76), (99, 77), (99, 78), (99, 79),
            (100, 70), (100, 71), (100, 72), (100, 73), (100, 74), (100, 75), (100, 76), (100, 77), (100, 78),
            
            # Eastern Australia
            (101, 69), (101, 70), (101, 71), (101, 72), (101, 73), (101, 74), (101, 75), (101, 76), (101, 77), (101, 78),
            (102, 68), (102, 69), (102, 70), (102, 71), (102, 72), (102, 73), (102, 74), (102, 75), (102, 76), (102, 77),
            (103, 68), (103, 69), (103, 70), (103, 71), (103, 72), (103, 73), (103, 74), (103, 75), (103, 76), (103, 77),
            (104, 67), (104, 68), (104, 69), (104, 70), (104, 71), (104, 72), (104, 73), (104, 74), (104, 75), (104, 76),
            (105, 67), (105, 68), (105, 69), (105, 70), (105, 71), (105, 72), (105, 73), (105, 74), (105, 75), (105, 76),
            (106, 67), (106, 68), (106, 69), (106, 70), (106, 71), (106, 72), (106, 73), (106, 74), (106, 75),
            (107, 67), (107, 68), (107, 69), (107, 70), (107, 71), (107, 72), (107, 73), (107, 74), (107, 75),
            (108, 67), (108, 68), (108, 69), (108, 70), (108, 71), (108, 72), (108, 73), (108, 74),
            (109, 67), (109, 68), (109, 69), (109, 70), (109, 71), (109, 72), (109, 73), (109, 74),
            (110, 68), (110, 69), (110, 70), (110, 71), (110, 72), (110, 73),
            (111, 68), (111, 69), (111, 70), (111, 71), (111, 72), (111, 73),
            (112, 69), (112, 70), (112, 71), (112, 72), (112, 73),
            (113, 70), (113, 71), (113, 72), (113, 73),
            
            # Tasmania
            (91, 83), (91, 84), (91, 85),
            (92, 83), (92, 84), (92, 85), (92, 86),
            (93, 82), (93, 83), (93, 84), (93, 85),
        ]
    ...
    def _intersects_australia(self, bounds: Dict) -> bool:
        ...
        intersects = not (
            max_lon < self.AUSTRALIA_BOUNDS['min_lon'] or
            min_lon > self.AUSTRALIA_BOUNDS['max_lon'] or
            max_lat < self.AUSTRALIA_BOUNDS['min_lat'] or
            min_lat > self.AUSTRALIA_BOUNDS['max_lat']
        )
    ...
    def get_tiles_in_region(self, min_lat: float, max_lat: float, 
                           min_lon: float, max_lon: float) -> List[TileInfo]:
        """Get tiles that intersect with a specified geographic region."""
        intersecting_tiles = []
        
        for tile in self.tiles:
            if (tile.center_lat >= min_lat and tile.center_lat <= max_lat and
                tile.center_lon >= min_lon and tile.center_lon <= max_lon):
...
class TileInitializer:
    ...
    def initialize_database_tiles(self, update_existing: bool = False) -> int:
        ...
        logger.info(f"Tile initialization complete: {tiles_created} created, "
