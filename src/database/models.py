...
class LandsatTile(Base):
    ...
    # Tile identification
    tile_id = Column(String(20), unique=True, nullable=False, index=True)  # e.g., "090084", "091084"
    ...
    status = Column(String(20), nullable=False, default=ProcessingStatus.PENDING.value, index=True)
...
class DetectionAlert(Base):
    ...
    job_id = Column(String(50), nullable=False, index=True)  # Foreign key to processing_jobs
    tile_id = Column(String(20), nullable=False, index=True)  # Foreign key to landsat_tiles
    ...
    # Classification
    clearing_type = Column(String(50), nullable=True)  # e.g., "forest", "vegetation", "unknown"
    severity = Column(String(20), nullable=True)      # e.g., "low", "medium", "high"
    
    # Verification status
    is_verified = Column(Boolean, default=False, nullable=False)
    verification_status = Column(String(20), default="pending")  # pending, confirmed, false_positive
