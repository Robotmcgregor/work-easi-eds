        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.H3(
                            "Landsat Tiles & Detections", style={"color": "#2c3e50"}
                        ),
                        html.Div(
                            [
                                html.Label(
        ...
        with get_db_session() as session:
            ...
            return html.Div(
                [
                    ...
                    html.Div(
                        [
                            html.H4("OK", style={"margin": 0, "color": "#f39c12"}),
                    ...
                    try:
                        ...
                        if geom["type"] == "Polygon":
                            ...
                            polygon_fig.update_layout(
                                ...
                                showlegend=False,
                                title=dict(text="NVMS Detection Polygon", x=0.5),
                            )
                        else:
                ...
                if alert[7]:  # detection_geojson
                    try:
                        ...
                        if geom["type"] == "Polygon":
                            ...
                            polygon_fig.update_layout(
                                ...
                                margin=dict(l=0, r=0, t=30, b=0),
                                showlegend=False,
                                title=dict(text="Live Detection Alert", x=0.5),
                            )
                        else:
                            polygon_fig.add_annotation(
                                text="Non-polygon geometry type",
                    ...
                    if alert[5] and alert[6]:  # detection_lat, detection_lon
                        ...
                        polygon_fig.update_layout(
                            ...
                            margin=dict(l=0, r=0, t=30, b=0),
                            showlegend=False,
                            title=dict(text="Detection Point Location", x=0.5),
                        )
                    else:
                        polygon_fig.add_annotation(
