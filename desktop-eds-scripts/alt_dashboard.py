...
if __name__ == "__main__":
    ...
    @app.callback(
        [Output("map-status", "children"), Output("alt-map", "figure")],
                    ...
                    if len(run_tiles) > 0:
                        ...
                        fig.add_trace(
                            go.Scattermapbox(
                                ...
                                mode="markers",
                                marker=dict(
                                    size=6, color=color_map[run_type], opacity=0.8
                                ),
                                text=run_tiles["tile_id"],
                                name=run_type,
                                hovertemplate="<b>%{text}</b><br>Run: "
                                + run_type
                                + "<extra></extra>",
                            )
                        )
    ...
    print("Starting ALTERNATIVE DASHBOARD...")
