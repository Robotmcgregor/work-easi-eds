        ...
        [
            ...
            html.Div(
                [
                    ...
                    html.P(
                        "Land Clearing Detection Dashboard with Real NVMS Data",
                        style={
                            "textAlign": "center",
                            "color": "#7f8c8d",
                            "marginBottom": 30,
            ...
            html.Div(
                [
                    html.Label(
                        "Map Style:", style={"marginRight": 10, "fontWeight": "bold"}
                    ),
                    dcc.RadioItems(
                        id="map-style",
                        options=[
                    ...
                    html.Br(),
                    html.Label(
                        "Show Layers:", style={"marginRight": 10, "fontWeight": "bold"}
                    ),
                    dcc.Checklist(
                        id="show-layers",
                        options=[
            ...
            # Map
            html.Div([dcc.Graph(id="working-map", style={"height": "600px"})]),
            # Update interval
        ...
        try:
            ...
            with db.get_session() as session:
                ...
                if "tiles" in show_layers:
                    tiles = session.query(
                        LandsatTile
                    ).all()  # Show ALL tiles, not just 100
                ...
                if "detections" in show_layers:
                    detections = (
                        session.query(NVMSDetection).limit(200).all()
